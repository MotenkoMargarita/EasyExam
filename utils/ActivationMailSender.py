...
def send_activation_email(curr_user: User):
    o = urlparse(request.base_url)
    link = o.scheme + "://" + o.netloc

    activation_link = link + '/registration/activate/' + curr_user.email + '/' + curr_user.activation_code
...
<table bgcolor="#f3f2f3" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
    ...
    <tr style="vertical-align: top;" valign="top">
        <td style="word-break: break-word; vertical-align: top;" valign="top">
                                    ...
                                    <div style="color:#555555;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;line-height:1.2;padding-top:20px;padding-right:38px;padding-bottom:15px;padding-left:38px;">
                                        <div class="txtTinyMce-wrapper"
                                            ...
                                            <p style="font-size: 42px; line-height: 1.2; word-break: break-word; text-align: center; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 50px; margin: 0;">
                                                <span style="font-size: 42px; color: #2a272b;"><strong>Спасибо за регистрацию!</strong></span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
           ...
           + """ подтвердите почту для доступа к аккаунту.</span>
                                            </p>
                                    ...
                                    <div align="center" class="button-container"
                                        ...
                                        <![endif]-->
                                        <a target="_blank" href=" """ + activation_link \
           + """ " style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#004afd;border-radius:60px;-webkit-border-radius:60px;-moz-border-radius:60px;width:auto; width:auto;;border-top:1px solid #004afd;border-right:1px solid #004afd;border-bottom:1px solid #004afd;border-left:1px solid #004afd;padding-top:12px;padding-bottom:16px;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                            <span style="padding-left:32px;padding-right:32px;font-size:16px;display:inline-block;letter-spacing:undefined;"><span
                                                    style="font-size: 16px; margin: 0; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><strong>Подтвердить</strong></span></span>
                                        </a>
                                    ...
                                    <div style="color:#555555;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;line-height:1.5;padding-top:10px;padding-right:38px;padding-bottom:10px;padding-left:38px;">
                                        <div class="txtTinyMce-wrapper"
                                             style="line-height: 1.5; font-size: 12px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; color: #555555; mso-line-height-alt: 18px;">
                                            <p style="line-height: 1.5; word-break: break-word; text-align: center; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 16px; mso-line-height-alt: 24px; margin: 0;">
                                                <span style="font-size: 16px; color: #2a272b;"> Или перейдите по ссылке  
...
<!--[if (IE)]></div><![endif]-->
    ...
    msg = Message('Registration', sender=app.config['MAIL_USERNAME'], recipients=[curr_user.email])
    msg.html = html
    mail.send(msg)
